...
<div class="px-4">
    <div class="max-w-2xl mx-auto">
        ...
        <h1 class="text-3xl font-bold text-gray-900 mb-6">Tambah Barcode Baru</h1>
            ...
            <form action="{{ route('barcodes.store') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <textarea name="description" id="description" rows="4"
                              ...
                              placeholder="Masukkan deskripsi produk atau keterangan (opsional)">{{ old('description') }}</textarea>
